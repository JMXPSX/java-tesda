 ...
 * @author autocad
 */
public class Digits3GUIFrame extends javax.swing.JFrame {

    /**
     * Creates new form Digits3GUIFrame
     */
    public Digits3GUIFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Digits3GUI"));

        jLabel1.setText("Enter any 3 digit number :");

        jLabel4.setText("The sum of the three digit number is:");
        ...
        setBounds((screenSize.width-331)/2, (screenSize.height-216)/2, 331, 216);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       
       Integer dx, d1, d2, d3, dt;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Digits3GUIFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Digits3GUIFrame().setVisible(true);
            }
        });
    }
